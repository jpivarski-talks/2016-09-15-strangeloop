...
\scriptsize
\mbox{\hspace{-0.5 cm}}\begin{tabular}{l c c c c c c c c c c c c}
...
Bag               & \cellcolor{green!25}DONE   &         & \cellcolor{green!25}DONE   & \cellcolor{green!25}DONE   & \cellcolor{green!25}DONE   &                            &                            & \cellcolor{green!25}DONE  & & \\\hline
...
SparselyBin       & \cellcolor{yellow!50}DONE  &         & \cellcolor{yellow!50}DONE  & \cellcolor{yellow!50}DONE  & \cellcolor{yellow!50}DONE  &                            &                            &                           & & \\
...
Categorize        & \cellcolor{yellow!50}DONE  &         & \cellcolor{yellow!50}DONE  & \cellcolor{yellow!50}DONE  & \cellcolor{yellow!50}DONE  &                            &                            &                           & & \\
