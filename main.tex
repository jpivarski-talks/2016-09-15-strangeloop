...
\vspace{0.75 cm}
A {\bf histogram} is an approximation of a distribution, formed by partitioning a sample by a feature and counting how many items fall in each partition.

\vspace{0.25 cm}
The partitions are called {\bf bins}, and the content of each bin may be represented as the total count or the average density in that partition. [Start philosophical argument here.]
...
\begin{frame}[fragile]{Gallery of histogram APIs}
\vspace{0.25 cm}
\begin{columns}
...
\vspace{0.75 cm}
\centering They all require input data before giving you a histogram.
\vspace{0.75 cm}
\end{minipage}}
\end{center}
\vspace{5 cm}
...
\uncover<3->{This interface lets you provide the data gradually and view partial results. \\ It presumes the dataset is too big for one function call.}
\vspace{-0.5 cm}
\end{frame}
